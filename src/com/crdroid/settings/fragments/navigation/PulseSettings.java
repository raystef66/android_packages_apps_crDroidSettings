...
public class PulseSettings extends SettingsPreferenceFragment implements
    ...
    PreferenceCategory mFadingBarsCat;
    PreferenceCategory mSolidBarsCat;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mFadingBarsCat = (PreferenceCategory)findPreference("pulse_fading_bars_category");
        mFadingBarsCat.setEnabled(renderMode == RENDER_STYLE_FADING_BARS);

        mSolidBarsCat = (PreferenceCategory) findPreference("pulse_2");
        mSolidBarsCat.setEnabled(renderMode == RENDER_STYLE_SOLID_LINES);

        int pulseColor = Settings.System.getIntForUser(resolver,
        ...
        mLavaLampEnabled.setChecked(Settings.System.getIntForUser(resolver,
        ...
        int customdimen = Settings.System.getIntForUser(resolver,
        ...
        int customdiv = Settings.System.getIntForUser(resolver,
        ...
        int filled = Settings.System.getIntForUser(resolver,
        ...
        int empty = Settings.System.getIntForUser(resolver,
        ...
        int fudge = Settings.System.getIntForUser(resolver,
        ...
        int solidfudge = Settings.System.getIntForUser(resolver,
        ...
        int speed = Settings.System.getIntForUser(resolver,
        ...
        int fspeed = Settings.System.getIntForUser(resolver,
        ...
        int count = Settings.System.getIntForUser(resolver,
        ...
        int opacity = Settings.System.getIntForUser(resolver,
...
/*
        int buttonsOpacity = Settings.System.getIntForUser(resolver,
...
*/
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mRenderMode) {
            ...
            return true;
        } else if (preference == mLavaLampEnabled) {
            boolean enabled = (Boolean) newValue;
            Settings.System.putIntForUser(resolver,
            ...
            int val = (Integer) newValue;
            Settings.System.putIntForUser(resolver,
                    Settings.System.PULSE_SOLID_FUDGE_FACTOR, val, UserHandle.USER_CURRENT);
            return true;
...
*/
    ...
    public static void reset(Context mContext) {
        ...
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_RENDER_STYLE_URI,
             RENDER_STYLE_SOLID_LINES, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.FLING_PULSE_ENABLED,
             0, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_AUTO_COLOR,
             0, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.FLING_PULSE_COLOR,
             Color.WHITE, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.FLING_PULSE_LAVALAMP_ENABLED,
             1, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_CUSTOM_DIMEN,
             14, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_CUSTOM_DIV,
             16, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_FILLED_BLOCK_SIZE,
             4, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_EMPTY_BLOCK_SIZE,
             1, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_CUSTOM_FUDGE_FACTOR,
             4, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_SOLID_FUDGE_FACTOR,
             5, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_LAVALAMP_SOLID_SPEED,
             10000, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.FLING_PULSE_LAVALAMP_SPEED,
             10000, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_SOLID_UNITS_COUNT,
             64, UserHandle.USER_CURRENT);
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_SOLID_UNITS_OPACITY,
             200, UserHandle.USER_CURRENT);
/*
        Settings.System.putIntForUser(resolver, Settings.System.PULSE_CUSTOM_BUTTONS_OPACITY,
             200, UserHandle.USER_CURRENT);
*/
    }
